...
namespace Stateless.Graph
{
    ...
    /// </summary>
    public class UmlDotGraphStyle : GraphStyle
    {
        ...
        /// <returns></returns>
        internal override string FormatOneTransition(string sourceNodeName, string trigger, IEnumerable<string> actions,
        ...
        /// <returns></returns>
        internal override string FormatOneDecisionNode(string nodeName, string label)
        {
