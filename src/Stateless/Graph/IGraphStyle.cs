...
namespace Stateless.Graph
{
    ...
    public abstract class GraphStyle
    {
                ...
                else
                {
                    ...
                    else
                    {
                        if (transit is DynamicTransition dyn)
                            line = FormatOneTransition(dyn.SourceState.NodeName,
        ...
        /// <returns></returns>
        internal virtual string FormatOneTransition(string sourceNodeName, string trigger, IEnumerable<string> actions,
            string destinationNodeName, IEnumerable<string> guards)
        {
            throw new InvalidOperationException(
                "If you use IGraphStyle.FormatAllTransitions() you must implement an override of FormatOneTransition()");
        }
    }
}