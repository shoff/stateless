...
namespace Stateless
{
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        {
            private readonly Func<TState, StateRepresentation> lookup;
            private readonly StateRepresentation representation;
            ...
            /// </summary>
            public TState State => this.representation.UnderlyingState;
            ...
            public StateConfiguration InternalTransitionIf(TTrigger trigger, Func<object[], bool> guard,
                Action<Transition> entryAction, string guardDescription = null)
            {
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));

                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger, guard,
                    (t, args) => entryAction(t), guardDescription));
                return this;
            }
                ...
                Action internalAction, string guardDescription = null)
            {
                ...
                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger, guard,
                    (t, args) => internalAction(), guardDescription));
                return this;
            }
            ...
            /// <param name="guardDescription">A description of the guard condition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf<TArg0>(TTrigger trigger, Func<object[], bool> guard,
                Action<Transition> internalAction, string guardDescription = null)
            {
                if (internalAction == null) throw new ArgumentNullException(nameof(internalAction));

                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger, guard,
                    (t, args) => internalAction(t), guardDescription));
                return this;
            }
            ...
            public StateConfiguration InternalTransitionIf<TArg0>(TriggerWithParameters<TArg0> trigger,
                Func<TArg0, bool> guard, Action<TArg0, Transition> internalAction, string guardDescription = null)
            {
                if (internalAction == null) throw new ArgumentNullException(nameof(internalAction));

                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger.Trigger,
                    TransitionGuard.ToPackedGuard(guard),
                    (t, args) => internalAction(ParameterConversion.Unpack<TArg0>(args, 0), t), guardDescription));
                return this;
            }
            ...
            public StateConfiguration InternalTransitionIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<object[], bool> guard, Action<TArg0, TArg1, Transition> internalAction,
                string guardDescription = null)
            {
                if (internalAction == null) throw new ArgumentNullException(nameof(internalAction));

                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger.Trigger, guard,
            ...
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, bool> guard, Action<TArg0, TArg1, Transition> internalAction,
                string guardDescription = null)
            {
                if (internalAction == null) throw new ArgumentNullException(nameof(internalAction));

                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(
                    trigger.Trigger,
                    TransitionGuard.ToPackedGuard(guard),
                    (t, args) => internalAction(
                        ParameterConversion.Unpack<TArg0>(args, 0),
                ...
                Action<TArg0, TArg1, TArg2, Transition> internalAction, string guardDescription = null)
            {
                ...
                this.representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger.Trigger,
                    TransitionGuard.ToPackedGuard(guard), (t, args) => internalAction(
                        ParameterConversion.Unpack<TArg0>(args, 0),
                        ParameterConversion.Unpack<TArg1>(args, 1),
                        ParameterConversion.Unpack<TArg2>(args, 2), t),
                    guardDescription));
            ...
            public StateConfiguration PermitIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                TState destinationState, Func<TArg0, TArg1, bool> guard, string guardDescription = null)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                TState destinationState, params Tuple<Func<TArg0, TArg1, bool>, string>[] guards)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            public StateConfiguration PermitIf<TArg0, TArg1, TArg2>(TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                TState destinationState, Func<TArg0, TArg1, TArg2, bool> guard, string guardDescription = null)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitIf<TArg0, TArg1, TArg2>(TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                TState destinationState, params Tuple<Func<TArg0, TArg1, TArg2, bool>, string>[] guards)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            {
                return InternalPermitReentryIf(trigger, this.representation.UnderlyingState, null);
            }
                ...
                string guardDescription = null)
            {
                return InternalPermitReentryIf(
                    trigger,
                    this.representation.UnderlyingState,
                    new TransitionGuard(guard, guardDescription));
            }
            ...
            public StateConfiguration PermitReentryIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, bool> guard, string guardDescription = null)
            {
                return InternalPermitReentryIf(
                    trigger.Trigger,
                    this.representation.UnderlyingState,
            ...
            public StateConfiguration Ignore(TTrigger trigger)
            {
                ...
                this.representation.AddTriggerBehaviour(
            ...
            /// </param>
            /// <returns>The receiver.</returns>
            public StateConfiguration IgnoreIf<TArg0, TArgo1>(TriggerWithParameters<TArg0, TArgo1> trigger,
                Func<TArg0, TArgo1, bool> guard, string guardDescription = null)
            {
                this.representation.AddTriggerBehaviour(
                    new IgnoredTriggerBehaviour(
                        trigger.Trigger,
            ...
            public StateConfiguration IgnoreIf<TArg0, TArg1, TArg2>(TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<TArg0, TArg1, TArg2, bool> guard, string guardDescription = null)
            {
                this.representation.AddTriggerBehaviour(
                    new IgnoredTriggerBehaviour(
                        trigger.Trigger,
            ...
            {
                this.representation.AddActivateAction(
                    activateAction,
            ...
            {
                this.representation.AddDeactivateAction(
                    deactivateAction,
            ...
            public StateConfiguration OnEntry(Action entryAction, string entryActionDescription = null)
            {
                ...
                this.representation.AddEntryAction(
                    (t, args) => entryAction(),
            ...
            public StateConfiguration OnEntryFrom<TArg0>(TriggerWithParameters<TArg0> trigger,
                Action<TArg0> entryAction, string entryActionDescription = null)
            {
            ...
            /// <returns>The receiver.</returns>
            public StateConfiguration OnEntryFrom<TArg0>(TriggerWithParameters<TArg0> trigger,
                Action<TArg0, Transition> entryAction, string entryActionDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));
            ...
            public StateConfiguration OnEntryFrom<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Action<TArg0, TArg1> entryAction, string entryActionDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));

                this.representation.AddEntryAction(trigger.Trigger,
                    (t, args) => entryAction(
                        ParameterConversion.Unpack<TArg0>(args, 0),
                        ParameterConversion.Unpack<TArg1>(args, 1)),
                    InvocationInfo.Create(entryAction, entryActionDescription));
            ...
            /// <returns>The receiver.</returns>
            public StateConfiguration OnEntryFrom<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Action<TArg0, TArg1, Transition> entryAction, string entryActionDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));

                this.representation.AddEntryAction(trigger.Trigger, (t, args) => entryAction(
                        ParameterConversion.Unpack<TArg0>(args, 0),
                        ParameterConversion.Unpack<TArg1>(args, 1), t),
                    InvocationInfo.Create(entryAction, entryActionDescription));
                return this;
            ...
            public StateConfiguration OnExit(Action exitAction, string exitActionDescription = null)
            {
                ...
                this.representation.AddExitAction(
                    t => exitAction(),
            ...
            {
                var state = this.representation.UnderlyingState;

                // Check for accidental identical cyclic configuration
                if (state.Equals(superstate))
                    throw new ArgumentException(
                        $"Configuring {state} as a substate of {superstate} creates an illegal cyclic configuration.");
                ...
                var activeRepresentation = this.lookup(superstate);
                while (activeRepresentation.Superstate != null)
                {
                    ...
                    if (superstates.Contains(activeRepresentation.Superstate.UnderlyingState))
                        throw new ArgumentException(
                            $"Configuring {state} as a substate of {superstate} creates an illegal nested cyclic configuration.");

                    superstates.Add(activeRepresentation.Superstate.UnderlyingState);
                    activeRepresentation = this.lookup(activeRepresentation.Superstate.UnderlyingState);
                }

                // The check was OK, we can add this
                var superRepresentation = this.lookup(superstate);
                this.representation.Superstate = superRepresentation;
            ...
            public StateConfiguration PermitDynamicIf<TArg0>(TriggerWithParameters<TArg0> trigger,
                Func<TArg0, TState> destinationStateSelector, Func<bool> guard, string guardDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0>(TriggerWithParameters<TArg0> trigger,
                Func<TArg0, TState> destinationStateSelector, params Tuple<Func<bool>, string>[] guards)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            public StateConfiguration PermitDynamicIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, TState> destinationStateSelector, Func<bool> guard, string guardDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            /// <typeparam name="TArg1">Type of the second trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, TState> destinationStateSelector, params Tuple<Func<bool>, string>[] guards)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            public StateConfiguration PermitDynamicIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<TArg0, TArg1, TArg2, TState> destinationStateSelector, params Tuple<Func<bool>, string>[] guards)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0>(TriggerWithParameters<TArg0> trigger,
                Func<TArg0, TState> destinationStateSelector, Func<TArg0, bool> guard, string guardDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0>(TriggerWithParameters<TArg0> trigger,
                Func<TArg0, TState> destinationStateSelector, params Tuple<Func<TArg0, bool>, string>[] guards)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            /// <typeparam name="TArg1">Type of the second trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, TState> destinationStateSelector, Func<TArg0, TArg1, bool> guard,
                string guardDescription = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            /// <typeparam name="TArg1">Type of the second trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0, TArg1>(TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, TState> destinationStateSelector, Tuple<Func<TArg0, TArg1, bool>, string>[] guards)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                if (destinationStateSelector == null) throw new ArgumentNullException(nameof(destinationStateSelector));
            ...
            {
                if (destination.Equals(this.representation.UnderlyingState))
            ...
            {
                this.representation.AddTriggerBehaviour(new TransitioningTriggerBehaviour(trigger, destinationState, null));
                return this;
            }
            ...
            {
                this.representation.AddTriggerBehaviour(
                    new TransitioningTriggerBehaviour(trigger, destinationState, transitionGuard));
                return this;
            }
            ...
            private StateConfiguration InternalPermitReentryIf(TTrigger trigger, TState destinationState,
                TransitionGuard transitionGuard)
            {
                this.representation.AddTriggerBehaviour(new ReentryTriggerBehaviour(trigger, destinationState,
                    transitionGuard));
                return this;
            }
            ...
            private StateConfiguration InternalPermitDynamicIf(TTrigger trigger,
                ...
                string destinationStateSelectorDescription, TransitionGuard transitionGuard,
                DynamicStateInfos possibleDestinationStates)
            {
                ...
                this.representation.AddTriggerBehaviour(new DynamicTriggerBehaviour(trigger,
            ...
            {
                if (this.representation.HasInitialTransition)
                    throw new InvalidOperationException(
                        $"This state has already been configured with an inital transition ({this.representation.InitialTransitionTarget}).");
                if (targetState.Equals(State))
                    throw new ArgumentException(
                        "Setting the current state as the target destination state is not allowed.",
                        nameof(targetState));

                this.representation.SetInitialTransition(targetState);
                return this;
            }
        }
    }
